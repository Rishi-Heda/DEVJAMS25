    ...
    if db_connection:
        try:
            ...
            if not incidents:
                ...
                # --- IMPROVEMENT 1: Use the full original text for better context ---
                # This provides more specific details for creating the embeddings.
                ...
                if embeddings is not None:
                    ...
                    # A lower value means reports must be more similar to be grouped together.
                    # You can tune this value (e.g., 0.3, 0.4) to change the group size.
