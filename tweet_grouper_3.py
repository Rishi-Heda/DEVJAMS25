    ...
    if db_connection:
        try:
            ...
            if not incidents:
                ...
                # --- IMPROVEMENT 1: Use a cleaner, more focused text for embedding ---
                # This provides a better signal by combining the already-extracted issue and location.
                texts_for_embedding = [f"Issue: {inc['extracted_issue']} at Location: {inc['extracted_location']}" for inc in incidents]
                ...
                if embeddings is not None:
                    ...
                    # --- IMPROVEMENT 2: Use a smaller 'eps' for tighter, more specific clusters ---
                    # A lower value (e.g., 0.25) forces the algorithm to be stricter.
                    # You can tune this value to change the group size.
